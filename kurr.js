...
const ownerNumber = "6281914523681@s.whatsapp.net"
const dtod = "6281914523681@s.whatsapp.net"
const otod = "6281914523681@s.whatsapp.net"
// STICKER WM
...
try {
		...
		cmhit.push(command)
        mess = {
			wait: 'Sabar Goblok lagi proses...',
			success: 'Success',
			error: {
				stick: 'Cannot access videos!',
				Iv: 'link ga valid tod!',
                api: 'Error'
			},
			only: {
				group: 'Hanya untuk di dalam grup asu!',
				ownerG: 'Khusus pembuat grup Tod!',
				ownerB: 'Khusus owner bang!',
				admin: 'Khusus Admin Group, member gblk!',
				Badmin: 'Jadiin bot sebagai admin grup dulu sayang!'
			}
		}
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `${NamaBot}`, "footerText": "©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const fvid = {
	 ...
	 { remoteJid: "6281914523681-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
                 "title": `${tampilUcapan} ${pushname}`,
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6281914523681`}}})
		}
...
if(budy.includes('Rizky')){
cpref = `Hayo Ngomongin Rizky Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Rizky_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/kurrsadboy')
}
if(isButton == 'ytm'){
reply('http://youtube.com/c/Rizky')
}
...
Silahkan pilih, apakah kamu mau aku kirim virtex?`, `Virtex By ©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀`, [
          {
...
`
sendButLocation(from, `${menu}`, "©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                nama = ' CATALOG MENU '
       ownerJid = "6281914523681@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
anu = kurr.prepareMessageFromContent(from,{
					"productMessage": {
						"product": {
								"productImage": {
								 "url": "https://mmg.whatsapp.net/d/f/AuuosqpYPPcG2eAxZ2Oja9tCMwu36q6OxWKAma1E_1n8.enc",
						"mimetype": "image/jpeg",
						"fileSha256": "uxP+jrtHmwycqoDIcTYhK1k5/ooyhv3IMiN4aWtEjkE=",
						"fileLength": "48573",
						"height": 944,
						"width": 836,
						"mediaKey": "W//SppUqZzpvx7ZROYqgc7OCsqB1lEZ+fXPbrVHoVeM=",
						"fileEncSha256": "pOeM0koa6g7k1CITcgJCI9rlclGe8aRW6M0vlHPP4Sk=",
...
menu =`©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀`
gbutsan = [
{buttonId:`Hello Word!`,buttonText:{displayText:'SIAP BANG'},type:1}
]
...
－ JANGAN CALL/VC BOT
   LANGGAR BLOK BANNED`
sendButLocation(from, `${menu}`, "©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
const serialUser = createSerial(18)
	        ...
	        addRegisteredUser(sender, serialUser)
	         const jancok = `╭─❒ 「 VERIFY SUCCESFULL 」 ❒
 * Nama :* ${pushname}
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `YUKI OFFICIAL`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
case 'chiisaihentai':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=hardianto`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Rizky', imageMessage: imageMsg,
              contentText:`Subrek yt : Botz YukiChan`,buttons,headerType:4}
              ...
              break
                    ...
                    case 'meme':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjoke?apikey=hardianto`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Rizky', imageMessage: imageMsg,
              contentText:`Subrek yt : Botz YukiChan`,buttons,headerType:4}
...
case 'bj':
                ...
                case 'nsfw_avatar':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=hardianto`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Rizky', imageMessage: imageMsg,
              contentText:`Subrek yt : Botz YukiChan`,buttons,headerType:4}
...
case 'blackpink':
                ...
                case 'thunder':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} ©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=Rizky&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Botz YukiChan`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=Rizky&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Botz YukiChan`, quoted : ftrol})
                    })
                    break
case 'neko':
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=hardianto`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Rizky', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hentai?apikey=hardianto`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Rizky', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              ...
              break
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} ©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=Rizky&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Botz YukiChan`, quoted : ftrol})
                    })
                    break
                case 'arcade8bit':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=Rizky&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Botz YukiChan`, quoted : ftrol})
                    })
                    break
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} ©𝒀𝒖𝒌𝒊𝑪𝒉𝒂𝒏❀`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=Rizky&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Botz YukiChan`, quoted : ftrol}) 
                    })
                    break
...
break
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/caklontong?apikey=hardianto`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subscribe Rizky"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
break
            ...
            break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					atetepe = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=Rizky&text=${encodeURIComponent(c)}`)
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ${NamaBot}",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6281914523681"}}})
	}
    }
    }
    }
